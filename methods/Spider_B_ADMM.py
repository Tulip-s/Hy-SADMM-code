...
"""
general single loop SARAH algorithm 
"""

def Spider_B_ADMM(param,
                    x0,
                    y0,
                    lamb0,
                    eta,
    ...
    # b_batch = int(round( N**(1/2) ))
    max_inner =  int(round(np.sqrt( N )))
    # max_outer = maxiter // max_inner + 1
    print_interval = 20

    x_test = param['x_test']
    y_test = param['y_test']
    
    print( 'Classic spdb ADMM ...' )
    print(
